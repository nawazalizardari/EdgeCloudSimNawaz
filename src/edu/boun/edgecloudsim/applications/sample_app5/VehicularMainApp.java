...
//		mainHelper(outputFolder, "ITS_SCENARIO", "RANDOM", iterationNumber, 11); //1000 // RANDOM,PREDICTIVE,GAME_THEORY,MAB,AI_BASED
//		mainHelper(outputFolder, "ITS_SCENARIO", "RANDOM", iterationNumber, 1000); //1000 // RANDOM,PREDICTIVE,GAME_THEORY,MAB,AI_BASED
		
			
		
		mainHelper(outputFolder, "ITS_SCENARIO", "RANDOM", iterationNumber, SS.getMaxNumOfMobileDev());
